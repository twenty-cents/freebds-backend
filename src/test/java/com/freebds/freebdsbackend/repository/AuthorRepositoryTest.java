...
class AuthorRepositoryTest {
    ...
    void findFirstByExternalId() {
        // Given author
        entityManager.persist(AuthorRepositoryTest.givenAuthor());

        // Execute test
        Author author = authorRepository.findFirstByExternalId("77");

        // Test results
        assertThat(author.getNickname().compareTo("Greg") == 0);

    }

    static Author givenAuthor(){
        // Given Author
